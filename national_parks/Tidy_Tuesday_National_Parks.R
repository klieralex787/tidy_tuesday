...
park_visits_filter <- park_visits %>%
  ...
  mutate(year = as.numeric(year),
         park_name = ifelse(unit_name == "Acadia National Park", "Acadia",
                     ifelse(unit_name == "Grand Canyon National Park", "Grand Canyon", 
                     ifelse(unit_name == "Great Smoky Mountains National Park", "Great Smoky Mountains",
                     ifelse(unit_name == "Shenandoah National Park", "Shenandoah National Park", "Other*")))))
